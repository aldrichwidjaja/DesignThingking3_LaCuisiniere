...
class category_4 extends StatefulWidget {

  @override
  category_4_state createState() => new category_4_state();

}

class category_4_state extends State<category_4> {
  Recipe recipe;
  bool inFavorites;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Western Recipes"),
          backgroundColor: Color(0xFF00C853),
        ),
        body: _buildRecipes(recipeType: RecipeType.Western));
  }
