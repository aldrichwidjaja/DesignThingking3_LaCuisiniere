...
class category_2 extends StatefulWidget {
  ...
  @override
  category_2_state createState() => new category_2_state();

}

class category_2_state extends State<category_2> {
  Recipe recipe;
  bool inFavorites;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("Indonesian Recipes"),
          backgroundColor: Color(0xFF00C853),
        ),
        body: _buildRecipes(recipeType: RecipeType.Indonesian));
  }
